...
freqs <- read.table("sim10k_lrt_freq",h=F)
covs <- read.table("sim10k_lrt_cov",h=F)
snpdet <- read.table("../snpdet_lab",h=F)[1:10000,]
...
data <- data.frame(chr = snpdet[,1], code = paste(snpdet[,2], snpdet[,3], snpdet[,4], sep = "_"), 
                     ...
                     F10.BSE3 = rep("F10.BSE3", nb), cov.F10.BSE3 = covs[,idx_F10[1]], freq.F10.BSE3 = freqs[,idx_F10[1]],
                     F10.BSE4 = rep("F10.BSE4", nb), cov.F10.BSE4 = covs[,idx_F10[2]], freq.F10.BSE4 = freqs[,idx_F10[2]],
                     F10.BSE5 = rep("F10.BSE5", nb), cov.F10.BSE5 = covs[,idx_F10[3]], freq.F10.BSE5 = freqs[,idx_F10[3]],
                     F10.BSE6 = rep("F10.BSE6", nb), cov.F10.BSE6 = covs[,idx_F10[4]], freq.F10.BSE6 = freqs[,idx_F10[4]],
                     F10.BSE8 = rep("F10.BSE8", nb), cov.F10.BSE8 = covs[,idx_F10[5]], freq.F10.BSE8 = freqs[,idx_F10[5]],
                     F10.BSE9 = rep("F10.BSE9", nb), cov.F10.BSE9 = covs[,idx_F10[6]], freq.F10.BSE9 = freqs[,idx_F10[6]],
                     F10.BSE11 = rep("F10.BSE11", nb), cov.F10.BSE11 = covs[,idx_F10[7]], freq.F10.BSE11 = freqs[,idx_F10[7]],
                     F10.BSE12 = rep("F10.BSE12", nb), cov.F10.BSE12 = covs[,idx_F10[8]], freq.F10.BSE12 = freqs[,idx_F10[8]] 
                     )
...
write.table(data, "sim.z.stats.all.txt",
