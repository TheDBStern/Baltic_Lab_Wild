...
vn=map(lambda x: 1.0/(2*50)+1.0/(2*50)+4.0/(2*x), Ne)
...
m={"F6.BSE3":0,"F6.BSE4":0,"F6.BSE5":0,"F6.BSE6":0,"F6.BSE8":0,"F6.BSE9":0,"F6.BSE11":0,"F6.BSE12":0,"F10.BSE3":0,"F10.BSE4":0,"F10.BSE5":0,"F10.BSE6":0,"F10.BSE8":0,"F10.BSE9":0,"F10.BSE11":0,"F10.BSE12":0}
p_crit=1.0/1000.0
g_snps=0
LRT=[]
LRT2=[]
...
# Scf_2L	15997755_C_G	A0	110	0.9	B0	86	0.93023255814	C0	97	0.907216494845	A7	95	0.947368421053	B7	139	0.884892086331	C7	518	0.916988416988	2.4980915448	2.60697816774	2.5225476806	2.67863792565	2.44929928338	2.55707227019
	...
	vz=[vn[0]+1.0/m["F6.BSE3"]+1.0/m["F10.BSE3"],vn[1]+1.0/m["F6.BSE4"]+1.0/m["F10.BSE4"],vn[2]+1.0/m["F6.BSE5"]+1.0/m["F10.BSE5"],vn[3]+1.0/m["F6.BSE6"]+1.0/m["F10.BSE6"],vn[4]+1.0/m["F6.BSE8"]+1.0/m["F10.BSE8"],vn[5]+1.0/m["F6.BSE9"]+1.0/m["F10.BSE9"],vn[6]+1.0/m["F6.BSE11"]+1.0/m["F10.BSE11"],vn[7]+1.0/m["F6.BSE12"]+1.0/m["F10.BSE12"]]
