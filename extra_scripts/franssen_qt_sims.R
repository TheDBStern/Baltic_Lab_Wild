...
for (loc in c(seq(10,200,10),1156)){
		for (rep in 1:1000){
			...
			sel <- '0.5:4.5:0.9:0.3'
			pre <- paste(c('opt0.9.sd0.3.ne200.loc',loc,'.rep',rep),collapse='')
			print(pre)
			gens <- '6,10'
			cmd <- paste('python ~/Desktop/Genomics_Programs/Franssen_qt_sim/python_qt_simulator/frequencyAt-pheno-quantitative.py --Ne 200 --selection ',
